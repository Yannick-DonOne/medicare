...
class OnCallComponent extends StatefulWidget {
  static String tag = '/OnCallComponent';

  @override
  OnCallComponentState createState() => OnCallComponentState();
}

class OnCallComponentState extends State<OnCallComponent> {
  @override
  void initState() {
    super.initState();
    init();
          ...
          Container(
            decoration: boxDecorationWithRoundedCorners(
              ...
              decorationImage: DecorationImage(
                  image: AssetImage(video_consult!), fit: BoxFit.cover),
            ),
          ),
          Positioned(
              bottom: 48,
              ...
              child: Container(
                ...
                child: Image.asset(profile_picture!)
                    .cornerRadiusWithClipRRect(24.0),
              )),
          Positioned(
            bottom: 48,
            left: 16,
        ...
        child: Container(
          ...
          child: MaterialButton(
            child: Container(
              ...
              child: Icon(Icons.chat_outlined, color: black, size: 24)
                  .paddingAll(10.0),
            ),
            onPressed: () {
              setState(() {});
