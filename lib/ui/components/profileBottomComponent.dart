...
class ProfileBottomComponent extends StatefulWidget {
  static String tag = '/ProfileBottomComponent';

  @override
  ProfileBottomComponentState createState() =>
      ProfileBottomComponentState();
}

class ProfileBottomComponentState extends State<ProfileBottomComponent> {
  ...
  List<ProfileCardData> mlProfileData = mlProfileDataList();
