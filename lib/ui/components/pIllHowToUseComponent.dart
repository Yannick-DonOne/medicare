...
class PillHowToUseComponent extends StatefulWidget {
  static String tag = '/PillHowToUseComponent';

  @override
  PillHowToUseComponentState createState() => PillHowToUseComponentState();
}

class PillHowToUseComponentState extends State<PillHowToUseComponent> {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          8.height,
          Image.asset(pharmacySlide2!,
                  height: 150, width: context.width(), fit: BoxFit.cover)
