...
import 'package:medicare/ui/screens/medicineScreen.dart';
...
class MedicationComponent extends StatefulWidget {
  static String tag = '/MedicationComponent';

  @override
  MedicationComponentState createState() => MedicationComponentState();
}

class MedicationComponentState extends State<MedicationComponent> {
  String? date = 'October 2021';

  List<MedicationData> data = mlPillDataList();
                ...
                children: <Widget>[
                  ...
                  Dismissible(
                    ...
                    child: primaryBackground(context, index).onTap(() {
                      MedicineScreen(index: 0).launch(context);
                    }),
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  8.height,
                  Text(('1 pill, once for day').validate(),
                      style: secondaryTextStyle()),
                  12.height,
                  Text('09:00 am - Before Eating',
