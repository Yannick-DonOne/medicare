...
class AddPaymentListComponent extends StatefulWidget {
  @override
  AddPaymentListComponentState createState() => AddPaymentListComponentState();
}

class AddPaymentListComponentState extends State<AddPaymentListComponent> {
  List<PaymentData> paymentData = mlPaymentDataList();
  int? selectedIndex = 0;
