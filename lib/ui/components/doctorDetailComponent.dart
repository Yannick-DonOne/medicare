...
class DoctorDetailComponent extends StatefulWidget {
  static String tag = '/DoctorDetailComponent';

  @override
  DoctorDetailComponentState createState() => DoctorDetailComponentState();
}

class DoctorDetailComponentState extends State<DoctorDetailComponent> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          8.height,
          Text(subtitle!, style: boldTextStyle(color: colorBlue)),
          8.height,
          Row(
            children: [
