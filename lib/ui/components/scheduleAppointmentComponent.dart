...
import 'calenderComponent.dart';

class ScheduleApoointmentSheet extends StatefulWidget {
  static String tag = '/ScheduleApoointmentSheet';

  @override
  ScheduleApoointmentSheetState createState() =>
      ScheduleApoointmentSheetState();
}

class ScheduleApoointmentSheetState
    extends State<ScheduleApoointmentSheet> {
  List<DoctorData> doctorDataList = doctorListDataList();
  List<String?> time = scheduleTimeList();
  int? selectedIndex = 0;
  String? selectedTime;
              ...
              children: [
                ListView(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Image.asset(
                              (doctorDataList[0].image).validate(),
                              fit: BoxFit.fill),
                        ),
                        8.width,
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text((doctorDataList[0].title).validate(),
                                style: boldTextStyle(size: 18)),
                            8.height,
                            Row(
                              children: [
                                Text((doctorDataList[0].subtitle).validate(),
                    ...
                    CalenderComponent(),
                    Text('Visiting Hours', style: boldTextStyle())
                        .paddingAll(16.0),
                    Wrap(
                      runSpacing: 8.0,
                      spacing: 8.0,
