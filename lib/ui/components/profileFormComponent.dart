...
class ProfileFormComponent extends StatefulWidget {
  static String tag = '/ProfileFormComponent';
    ...
    return Column(
      ...
      children: [
        Container(
            ...
            child: Icon(Icons.camera_alt_outlined, color: colorBlue)),
        16.height,
        ...
        AppTextField(
          ...
          decoration: InputDecoration(
            hintText: date_format!,
            hintStyle: secondaryTextStyle(size: 16),
            suffixIcon: Icon(Icons.calendar_today_outlined, color: colorBlue),
            enabledBorder: UnderlineInputBorder(
              borderSide: BorderSide(color: colorLightGrey),
            ),
          ),
