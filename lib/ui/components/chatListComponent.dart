...
class ChatListComponent extends StatefulWidget {
  ...
  ChatListComponent(this.data, this.color, this.screen);
              ...
              Stack(
                children: [
                  CircleAvatar(
                    ...
                    radius: 28.0,
                    child: Image.asset(doctor_image!, fit: BoxFit.cover, width: 56, height: 56).cornerRadiusWithClipRRect(30.0),
                  ),
                  Positioned(
                    bottom: 8.0,
                    right: 2.0,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: boxDecorationWithRoundedCorners(backgroundColor: colorBlue, boxShape: BoxShape.circle),
