...
import 'package:medicare/ui/screens/productMoreDetailScreen.dart';
import 'package:nb_utils/nb_utils.dart';

class ProductDetailComponent extends StatefulWidget {
  static String tag = '/ProductDetailComponent';

  @override
  ProductDetailComponentState createState() =>
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text('\$250.00 ',
                  style: boldTextStyle(size: 20, color: Colors.blue.shade600)),
              4.width,
              Text('\$350.00 ',
                  style: boldTextStyle(
                      color: Colors.grey,
          ...
          Row(
            ...
            ProductMoreDetailScreen().launch(context);
          }),
          8.height,
          Divider(thickness: 1.0),
          8.height,
