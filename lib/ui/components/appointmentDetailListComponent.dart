...
import 'package:medicare/ui/screens/appintmentDetailScreen.dart';
...
class AppointmentDetailListComponent extends StatefulWidget {
  static String tag = '/AppointmentDetailListComponent';

  @override
  AppointmentDetailListComponentState createState() =>
      AppointmentDetailListComponentState();
}

class AppointmentDetailListComponentState
    extends State<AppointmentDetailListComponent> {
                        ...
                        Row(
                          children: [
                            ...
                            Row(
                              ...
                              AppointmentDetailScreen().launch(context);
                            }).expand()
                          ],
                        ).paddingOnly(right: 16.0, left: 16.0),
                        16.height,
