...
class CreateMedicineComponent extends StatefulWidget {
  static String tag = '/CreateMedicineComponent';

  @override
  CreateMedicineComponentState createState() =>
      CreateMedicineComponentState();
}

class CreateMedicineComponentState extends State<CreateMedicineComponent> {
      ...
      child: Column(
        ...
        children: [
          ...
          HorizontalList(
            ...
            itemBuilder: (BuildContext context, int index) {
              return Container(
                ...
                child: Image.asset((medicineImage[index]).validate(),
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(tablet_per_time!, style: boldTextStyle()),
              AppTextField(
                textFieldType: TextFieldType.OTHER,
                decoration: InputDecoration(
                  hintText: tablet_per_time,
                  hintStyle: secondaryTextStyle(size: 16),
                  enabledBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color: colorLightGrey),
                  ),
          ...
          HorizontalList(
            ...
            itemBuilder: (BuildContext context, int index) {
              return Container(
                ...
                decoration: boxDecorationWithRoundedCorners(
                    backgroundColor: colorBlue, borderRadius: radius(12)),
                child: Text((time[index]).validate(),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                padding: EdgeInsets.all(4.0),
                decoration: boxDecorationWithRoundedCorners(
                    backgroundColor: Colors.cyan, borderRadius: radius(12)),
                child: Text('30',
                    style: boldTextStyle(color: white, size: 24),
                    textAlign: TextAlign.center),
              ),
