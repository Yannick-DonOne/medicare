...
import 'package:medicare/ui/screens/doctorDetailScreen.dart';
...
class DoctorListComponent extends StatefulWidget {
  static String tag = '/DoctorListComponent';

  @override
  DoctorListComponentState createState() => DoctorListComponentState();
}

class DoctorListComponentState extends State<DoctorListComponent> {
      ...
      children: [
                          ...
                          children: [
                            Container(
                              ...
                              decoration: boxDecorationWithRoundedCorners(
                                  ...
                                  borderRadius: radius(12)),
                              child: Image.asset(
                                  (doctorDataList[index].image).validate(),
                                  fit: BoxFit.fill),
                            ),
                            8.width,
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text((doctorDataList[index].title).validate(),
                                    style: boldTextStyle(size: 18)),
                                8.height,
                                Row(
                                  children: [
                                    Text(
                                        (doctorDataList[index].subtitle)
                                            .validate(),
                                        style: secondaryTextStyle()),
                                    8.width,
                                    Icon(Icons.star,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            RichText(
                              ...
                              DoctorDetailScreen().launch(context);
                            })
                          ],
                        ),
                      ],
        ...
        Container(
          ...
          showModalBottomSheet(
              ...
              context: context,
              builder: (builder) {
                return ScheduleApoointmentSheet();
              });
        }),
      ],
    );
