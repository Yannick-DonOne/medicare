...
class AllMedicineComponent extends StatefulWidget {
  @override
  AllMedicineComponentState createState() => AllMedicineComponentState();
}

class AllMedicineComponentState extends State<AllMedicineComponent> {
        ...
        children: data.map((e) {
          return Container(
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    12.height,
                    Text(time!, style: boldTextStyle(color: colorBlue)),
                    8.height,
                  ],
                ).expand(),
                8.width,
              ...
              MedicineScreen(index: 1).launch(context);
            }),
          );
        }).toList(),
      ),
