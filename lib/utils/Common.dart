...
Widget backToPrevious(BuildContext context, Color color) {
  return Align(
...
Widget roundedIconContainer(IconData iconData, Color color) {
  return Container(
...
Widget iconWithRoundedContainer(IconData iconData, Color color) {
  return Container(
...
Widget selectedNavigationbarIcon(IconData iconData) {
  return Container(
...
Widget backToPreviousWidget(BuildContext context, Color color) {
  return Align(
    alignment: Alignment.topLeft,
    child: IconButton(
